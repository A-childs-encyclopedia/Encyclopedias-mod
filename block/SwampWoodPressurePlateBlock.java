...
public class SwampWoodPressurePlateBlock extends EncyclopediasModModElements.ModElement {
	@ObjectHolder("encyclopedias_mod:swamp_wood_pressure_plate")
	public static final Block block = null;
	public SwampWoodPressurePlateBlock(EncyclopediasModModElements instance) {
		super(instance, 11);
	}
