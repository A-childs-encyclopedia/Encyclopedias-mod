...
public class SwampWoodLogBlock extends EncyclopediasModModElements.ModElement {
	@ObjectHolder("encyclopedias_mod:swamp_wood_log")
	public static final Block block = null;
	public SwampWoodLogBlock(EncyclopediasModModElements instance) {
		super(instance, 4);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("encyclopedias_mod:swamp_wood_log_match"),
			...
			event.getRegistry().register(feature.setRegistryName("swamp_wood_log"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("encyclopedias_mod:swamp_wood_log"), configuredFeature);
		}
	}
	@SubscribeEvent
