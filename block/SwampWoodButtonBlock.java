...
public class SwampWoodButtonBlock extends EncyclopediasModModElements.ModElement {
	@ObjectHolder("encyclopedias_mod:swamp_wood_button")
	public static final Block block = null;
	public SwampWoodButtonBlock(EncyclopediasModModElements instance) {
		super(instance, 12);
	}
